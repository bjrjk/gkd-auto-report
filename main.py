...
def submit(s: requests.Session):
    new_daily = {
        ...
        "dyzjzsj": "2021-02-08",             # date of first vaccination
        "dyzwjzyy": "",
        # 第二针接种
        "dezymjzqk": "3",                    # second vaccination situation  3.已接种
        "dezjzsj": "2021-03-06",             # date of second vaccination
        "dezwjzyy": "",
        # 第三针接种
        "dszymjzqk": "3",                    # third vaccination situation  3.已接种
        "dszjzsj": "2021-11-28",             # default time
